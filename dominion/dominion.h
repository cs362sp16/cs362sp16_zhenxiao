...
int fcouncil_room(struct gameState *state, int handPos); //card1
int fvillage(struct gameState *state, int handPos ); //card2
int fsteward(struct gameState *state, int handPos, int choice1, int choice2, int choice3); //card3
int fsea_hag(struct gameState *state);//card4
int fcutpurse(struct gameState *state, int handPos); //card5
#endif
